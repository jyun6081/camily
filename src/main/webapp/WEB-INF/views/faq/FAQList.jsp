						...
						<table class="table table-hover">
							...
							<tbody>
								<c:forEach items="${FAQList}" var="FAQList">
									<tr>
										<td>${FAQList.faqcode }</td>
										<td><a href="FAQView?faqcode=${FAQList.faqcode }">${FAQList.faqtitle }</a></td>
										<td> <i class="fa-regular fa-user"></i> ${FAQList.faqmid }</td>
										<td> <i class="fa-regular fa-calendar"></i> ${FAQList.faqdate }</td>
										<td> <i class="fa-regular fa-eye"></i> ${FAQList.faqhits }</td>
									</tr>
								</c:forEach>
							</tbody>
							<tfoot>
