...
<footer class="bg3 p-t-75 p-b-32">
	<div class="container">
			...
			<div class="col-sm-6 col-lg-3">
				<a href="#" class="logo">
					<img style="margin:0 auto;"
						src="${pageContext.request.contextPath}/resources/images/icons/logo-03.png" alt="IMG-LOGO">
				</a>
		...
		<p class="stext-107 cl6 txt-center">
			...
			</script> All rights reserved | Made with <i class="fa fa-heart-o" aria-hidden="true"></i> by CAMILY
			<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
