				...
				<div class="col-md-8 col-lg-9 p-b-80">
					<div class="p-r-45 p-r-0-lg">
						...
						<div class="p-b-63">
							...
							<a href="goreviewdetail?gorvcode=${cgrvList.cgrvcode }" class="hov-img0 how-pos5-parent rounded">
								<img src="${cgrvList.cgrvimage }" alt="IMG">	
							...
							<div class="p-t-32">
								...
								<div class="flex-w flex-sb-m p-t-18">
									<span class="flex-w flex-m stext-111 cl2 p-r-30 m-tb-10">
										...
										<span>
											좋아요 ${cgrvList.cgrvlike }
										</span>
									</span>
									<a href="goreviewdetail?gorvcode=${cgrvList.cgrvcode }" class="stext-101 cl2 hov-cl1 trans-04 m-tb-10">
										상세보기
